    ...
    <div className="py-5 px-4 bg-white  max-w-full">
      <div>
        <div className="max-w-4xl mx-auto mt-10">
          <div className="text-center mt-29 pt-2 text-3xl font-bold">
            Sejarah Inampa
          </div>
          <div className="min-h-screen  p-5">
            <p>
              INAMPA atau Indonesian Maritime Pilots Association adalah Asosiasi
              Perwira Pandu Maritim Indonesia yang merupakan sebuah
              Organisasi/Asosiasi Profesi yang berdiri pada tanggal 11 Maret
              2003 oleh seorang inisiator bernama Capt. Abdullah Syaifuddin yang
              saat itu menjabat sebagai Direktur Utama PT. Pelabuhan Indonesia –
              II (Persero).
            </p>
            <div>
            ...
            <div>
              ...
              <div className="md:px-4 py-5 px-5 mt-2">
                <ol className="list-disc list-inside p-2 ">
                  <li>
                    1. Sebagai wadah tunggal untuk menghimpun dan mempersatukan
                    para Perwira Pandu Maritim Indonesia.
                  </li>
                  <li>
              ...
              <p>
                ...
                karena memiliki peran kunci, langka, keahlian khusus dan banyak
                dibutuhkan. Saat ini INAMPA memiliki anggota + 1200 orang yang
                tersebar di penjuru Nusantara mulai dari Sabang sampai Merauke,
                dari Miangas sampe Rote dengan tugas utama dalam perspektif :
              </p>
              <div className="py-5">
              ...
              <p className="mt-5">
                ...
                masuk/keluar Pelabuhan di Indonesia termasuk di Perairan lainnya
                yang membutuhkan jasa berlayar secara safe, secure, efisien dan
                efektif, serta kegiatan yang berkaitan erat dengan daya saing
                Indonesia di Sektor Kemaritiman dan turun aktifikitasnya.
              </p>
              <p className="mt-5">
                ...
                berdomisili di London. IMPA adalah mitra strategis International
                Maritime Organization (IMO) Badan Perserikatan Bangsa-Bangsa
                (PBB) yang mengurusi Keselamatan Maritim Dunia dengan anggota ±
                175 Negara.
              </p>
            </div>
            {/* END TENTANG INAMPA */}
